...
<head>
    ...
    <title>SMP NEGERI 26 PONTIANAK | Log in</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
        ...
        @endif
        <img src="/images/tutwuri.png" alt="" style="opacity: .8; height: 15%; weight: 25%">
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            
            <a href="../../index2.html"><b>SMP NEGERI 26 PONTIANAK</b></a>
        </div>
        <!-- /.login-logo -->
